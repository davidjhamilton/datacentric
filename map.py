...
## Possible Next Steps
# You mention that you wanted to show locations over time. 
# Here is a timesearies heat map that may be what you could 
# use to show both location and time changes.
#
# https://www.kaggle.com/daveianhickey/how-to-folium-for-maps-heatmaps-time-data#Heatmap-with-time-series